...
const Register = () => {
    ...
    const handleGoogleRegister = async (tokenResponse) => {
        ...
        setLoading(true);
        try {
            const res = await userServices.googleRegister(tokenResponse);
            if (res) {
                if (res.data?.user) {
    ...
    const register = async (data) => {
        ...
        try {
            ...
            if (e.response.status == 409)
                setError("User with given email or username already exists");
            ...
            <div className="w-full max-w-sm flex flex-col">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input
                        ...
                        className="mb-2 rounded-lg border bg-transparent focus:border-blue-500 focus:ring-3 focus:ring-blue-500 px-3 py-2 w-full"
                        value={fullName}
